...
This module is combined with the :code:`atmosphere`, :code:`ionosphere`, and :code:`sky` modules to create a full forward model, which is controlled at a high level by the :code:`solver` module.
