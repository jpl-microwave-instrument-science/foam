##############################################################################
#
# This routine is taken from https://github.com/scivision/unlzw3
# Since it has not been maintained since 2020 and is lightweight, 
# it is included in FOAM without adding another package dependency 
# 
...
def unzip_z_file(inp: T.Any) -> bytes:
    """
    ...
    return bytes(bytearray(put)).decode()
